...
func TestPilaVaciaRecienCreada(t *testing.T) {
	pila := pila2.CrearPilaDinamica[int]()
...
func TestPilaVacia(t *testing.T) {
	pila := pila2.CrearPilaDinamica[bool]()
...
func TestApilarRespetaLifo(t *testing.T) {
	pila := pila2.CrearPilaDinamica[string]()
...
func TestPilaQueSeVacio(t *testing.T) {
	pila := pila2.CrearPilaDinamica[float64]()
...
func TestPilaDistintosTipos(t *testing.T) {
	// Pila de enteros
	pilaInt := pila2.CrearPilaDinamica[int]()
	...
	// Pila de cadenas
	pilaStr := pila2.CrearPilaDinamica[string]()
	pilaStr.Apilar("hola")
	...
	// Pila de floats
	pilaFloat := pila2.CrearPilaDinamica[float64]()
	...
	pilaStruct := pila2.CrearPilaDinamica[Persona]()
