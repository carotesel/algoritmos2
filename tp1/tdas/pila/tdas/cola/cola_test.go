...
func TestColaVaciaRecienCreada(t *testing.T) {
	cola := cola2.CrearColaEnlazada[string]()
	require.True(t, cola.EstaVacia())
}

func TestColaRecienCreada(t *testing.T) {
	cola := cola2.CrearColaEnlazada[int]()
	require.True(t, cola.EstaVacia())
...
func TestColaQueSeVacio(t *testing.T) {
	cola := cola2.CrearColaEnlazada[bool]()
...
func TestColaDistintosTipos(t *testing.T) {
	// Cola de enteros
	colaInt := cola2.CrearColaEnlazada[int]()
	...
	// Cola de cadenas
	colaStr := cola2.CrearColaEnlazada[string]()
	...
	// Cola de floats
	colaFloat := cola2.CrearColaEnlazada[float64]()
	...
	colaStruct := cola2.CrearColaEnlazada[Persona]()
